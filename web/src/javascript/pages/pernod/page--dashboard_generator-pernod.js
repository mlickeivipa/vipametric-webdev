...
function updateChartsAndTables(chartData) {
    ...
    if(no_data === false)
    {
        ...
        if (chart) {
            chart.yAxis[0].setExtremes(0, chartData.brand_totals.all_bottle_sales.goal);
            chart.series[0].points[0].update(chartData.brand_totals.all_bottle_sales.value);
        }
        ...
        if (chart) {
            chart.yAxis[0].setExtremes(0, chartData.brand_totals.all_samples_given.goal);
            chart.series[0].points[0].update(chartData.brand_totals.all_samples_given.value);
        }

        chart = $("div.impressions").highcharts();
        if (chart) {
            chart.yAxis[0].setExtremes(0, chartData.brand_totals.all_impressions.goal);
            chart.series[0].points[0].update(chartData.brand_totals.all_impressions.value);
        }
