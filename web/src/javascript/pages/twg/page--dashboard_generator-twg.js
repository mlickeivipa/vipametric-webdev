function createHtmlStructure() {
    ...
    $('<div class="conversion-rate"><div class="data-label">Conversation Rate</div><div class="data-value"><span class="percent-sign">%</span></div><div class="data-description">Total Sales / Impressions</div></div>').appendTo('div.brand-totals');
